...
def main_menu():
    ...
    print("            '.___.'")
#Squidward
    print(Fore.RED+"Welcome to No1seAutoXSS")
    print(Fore.LIGHTYELLOW_EX+"Please select an option:")
    print(f"{Fore.WHITE}1. Scan the web for XSS{Style.RESET_ALL}")
    print(f"{Fore.WHITE}2. Scan for XSS using an existing googledork.txt after selecting option one.{Style.RESET_ALL}")
